package flightService.service.Listener;
...
public class NewFlightEventListener {
    ...
    public void handleOrderPlacedEvent(NewFlightEvent event) {
        log.info("Order Placed Event Received, Sending OrderPlacedEvent to notificationTopic: {}", event.getId(),event.getFlightNumber(),event.getOrigin(),
